...
void CEcoLab1Sink_printIntMat(const void** mat, size_t size) {
...
int16_t ECOCALLMETHOD CEcoLab1Sink_OnSettingDiagCall(/* in */ struct IEcoLab1Events* me, int k) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    if (me == 0) {
        return -1;
    }
    printf("The setting %d diag has started\n", k);
    Sleep(long_pause);
    return 0;
}

int16_t ECOCALLMETHOD CEcoLab1Sink_OnSettingDiagElemCall(/* in */ struct IEcoLab1Events* me, int step, const void** mat, size_t size) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    if (me == 0) {
        return -1;
    }
    ...
    printf("Step %d: \n", step);
    CEcoLab1Sink_printIntMat(mat, size);
    printf("\n");
    Sleep(long_pause);
    return 0;
}

int16_t ECOCALLMETHOD CEcoLab1Sink_BeforeSettingDiag(/* in */ struct IEcoLab1Events* me, /* in */ const void* v, const void** mat, size_t size, int k) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    if (me == 0) {
        return -1;
    }
    printf("%d diag:\n", k);
    CEcoLab1Sink_printIntArray(v, size - abs(k));
    printf("\nInitial matrix:\n");
    CEcoLab1Sink_printIntMat(mat, size);
    printf("\n");
    Sleep(long_pause);
...
int16_t ECOCALLMETHOD CEcoLab1Sink_AfterSettingDiag(/* in */ struct IEcoLab1Events* me, /* in */ const void** mat, size_t size) {
    CEcoLab1Sink* pCMe = (CEcoLab1Sink*)me;
    if (me == 0) {
        return -1;
    }
...
IEcoLab1VTblEvents g_x2D2E3B9214F248A6A09ECB494B59C795VTblEvents = {
    ...
    CEcoLab1Sink_OnSettingDiagCall,
    CEcoLab1Sink_OnSettingDiagElemCall,
    CEcoLab1Sink_BeforeSettingDiag,
    CEcoLab1Sink_AfterSettingDiag
};
